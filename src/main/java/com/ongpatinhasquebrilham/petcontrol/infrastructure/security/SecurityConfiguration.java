    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/pets/unavailable").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/pets/{id}/available").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/pets/{id}/available").hasRole("ADMIN")
